...
To set the GPIO pins you wish to use simply replace <PIN_NUMBER> with the pin number. This can be found in the UART_Header.h file lines 23 and 25

```c
#define TX <PIN_NUMBER>
#define GPIO_TX_PIN_SEL (1ULL << TX)
#define RX <PIN_NUMBER>
